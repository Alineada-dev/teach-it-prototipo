...
**Proyecto**: TEACH-IT - Presentación Interactiva con Figma  
**Total de Pantallas**: 61

---

## 📋 Índice

1. [Archivo Principal: page.tsx](#archivo-principal)
2. [Componentes: pantallas-p14-final.tsx](#componentes-de-pantallas)
3. [Estructura del Proyecto](#estructura)
4. [Instrucciones de Conversión a PDF](#conversion-pdf)

---

## Archivo Principal

**Ubicación**: `teach-it/src/app/presentacion-figma/page.tsx`
...
**Ubicación**: `teach-it/src/app/presentacion-figma/pantallas-p14-final.tsx`
...
│   ├── app/
│   │   ├── presentacion-figma/
│   │   │   ├── page.tsx                    # Componente principal (61 pantallas)
│   │   │   └── pantallas-p14-final.tsx     # Todos los componentes de pantallas
│   │   └── ...
│   └── components/
│       └── ui/
│           └── button.tsx
...
\`\`\`bash
cd teach-it
open CODIGO_COMPLETO_PRESENTACION.md
\`\`\`
Luego: **Cmd+P** → **Guardar como PDF**

### Opción 2: Usando pandoc
\`\`\`bash
cd teach-it
pandoc CODIGO_COMPLETO_PRESENTACION.md -o CODIGO_COMPLETO_PRESENTACION.pdf --pdf-engine=xelatex
\`\`\`
...
- **Componentes de pantallas**: 61 pantallas interactivas
- **Tecnologías**: Next.js 14, TypeScript, Tailwind CSS, Framer Motion
- **Características**: Navegación interactiva, animaciones, auto-avance, navegación condicional
...
```bash
cd teach-it
pandoc CODIGO_COMPLETO_PRESENTACION.md -o CODIGO_COMPLETO_PRESENTACION.pdf
```
